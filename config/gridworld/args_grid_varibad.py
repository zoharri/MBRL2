...
def get_args(rest_args):
    ...
    parser.add_argument('--env_num_goals', type=int, default=21)
    parser.add_argument('--env_num_train_goals', type=int, default=21)
    parser.add_argument('--env_num_eval_goals', type=int, default=5)
    ...
    parser.add_argument('--saved_encoder', default=None, type=str, help='path to pretrained encoder model')
    parser.add_argument('--saved_task_decoder', default=None, type=str, help='path to pretrained task decoder model')
    parser.add_argument('--saved_reward_decoder', default=None, type=str,
                        help='path to pretrained reward decoder model')
