...
def get_args(rest_args):
    ...
    parser.add_argument('--env_num_goals', type=int, default=1000, help='number of frames to train')
    parser.add_argument('--env_num_train_goals', type=int, default=5, help='number of frames to train')
    parser.add_argument('--env_num_eval_goals', type=int, default=50, help='number of frames to train')
    parser.add_argument('--sample_random_envs', type=boolean_argument, default=True, help='number of frames to train')
    parser.add_argument('--num_dream_envs', type=int, default=0, help='number of frames to train')
    parser.add_argument('--saved_policy', type=str, default=None, help='number of frames to train')
    parser.add_argument('--saved_encoder', type=str, default=None, help='number of frames to train')
    parser.add_argument('--saved_reward_decoder', type=str, default=None, help='number of frames to train')
    parser.add_argument('--saved_task_decoder', type=str, default=None, help='number of frames to train')
    parser.add_argument('--saved_state_decoder', type=str, default=None, help='number of frames to train')
    parser.add_argument('--freeze_vae', type=str, default=False, help='number of frames to train')
    # --- GENERAL ---
    parser.add_argument('--seed',  nargs='+', type=int, default=[93])
    ...
    parser.add_argument('--exp_label', default='train5', help='label (typically name of method)')
