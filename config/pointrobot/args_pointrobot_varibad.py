...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='default_exp_name', help='label (typically name of method)')
    parser.add_argument('--env_name', default='SparsePointEnv-v0', help='environment to train on')
    parser.add_argument('--env_num_goals', type=int, default=1000)
    parser.add_argument('--env_num_train_goals', type=int, default=30)
    parser.add_argument('--env_num_eval_goals', type=int, default=50)
    parser.add_argument('--num_dream_envs', type=int, default=6)
    parser.add_argument('--num_processes', type=int, default=16,
                        help='how many training CPU processes / parallel environments to use (refault: 16)')
    parser.add_argument('--sample_random_envs', type=boolean_argument, default=True)
    parser.add_argument('--use_kde', type=boolean_argument, default=True)
    parser.add_argument('--delay_dream', type=int, default=5000)
    parser.add_argument('--update_kde_interval', type=int, default=3)
    parser.add_argument('--kde_from_train', type=boolean_argument, default=True)
    parser.add_argument('--kde_from_running_latents', type=boolean_argument, default=True)
    parser.add_argument('--freeze_vae', type=boolean_argument, default=False,
                        help='Do not train vae')
    parser.add_argument('--delayed_freeze', type=int, default=None)
    parser.add_argument('--latent_dim', type=int, default=5, help='dimensionality of latent space')

    parser.add_argument('--train_vae_on_dream', type=boolean_argument, default=False,
                        help='train the vae on the dream envs trajectories')
    parser.add_argument('--decode_task', type=boolean_argument, default=False, help='use task decoder')
    parser.add_argument('--clone_dream_vae', type=boolean_argument, default=False, help='use task decoder')
    parser.add_argument('--use_mixup', type=boolean_argument, default=False, help='use task decoder')

    parser.add_argument('--saved_reward_decoder',
                        default=None,
                        type=str, help='path to pretrained reward decoder model')
    parser.add_argument('--saved_encoder',
                        default=None,
                        type=str, help='path to pretrained reward decoder model')
    #
    parser.add_argument('--seed', nargs='+', type=int, default=[206])
    # --- POLICY ---
    ...
    parser.add_argument('--policy_optimiser', type=str, default='adam', help='choose: rmsprop, adam, adam')
    ...
    parser.add_argument('--vae_batch_num_trajs', type=int, default=5,
    ...
    parser.add_argument('--saved_policy', default=None, type=str, help='path to pretrained policy model')

    parser.add_argument('--saved_state_decoder', default=None, type=str, help='path to pretrained state decoder model')
    parser.add_argument('--saved_task_decoder', default=None, type=str, help='path to pretrained task decoder model')
