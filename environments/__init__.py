...
register(
    'SparsePointEnvEdge-v0',
    entry_point='environments.navigation.point_robot:SparsePointEnv',
    kwargs={'goal_radius': 0.2,
            'max_episode_steps': 30,
            'goal_sampler': 'semi-circle-edge'
            },
    max_episode_steps=30,
)
register(
    'SparsePointEnvFull-v0',
    entry_point='environments.navigation.point_robot:SparsePointEnv',
    kwargs={'goal_radius': 0.2,
            'max_episode_steps': 100,
            'goal_sampler': 'circle'
...
register(
    'DreamEnv-v0',
    entry_point='environments.dream_env:DreamEnv',
    kwargs={'use_kde': False, 'base_env': None, 'encoder': None, 'decoder': None, 'kde': None, 'kde_from_train': False,
            'kde_from_running_latents': False,
            'vae_for_kde': None, 'use_mixup': False},
    max_episode_steps=100,
)
