...
class GridNavi(gym.Env):
    ...
    def __init__(self, num_cells:int=5, num_steps:int=15):
    ...
    def set_possible_tasks(self, tasks:List[int]):
        self.possible_goals = [self.possible_goals[task] for task in tasks]
