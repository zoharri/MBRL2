...
class PointEnv(Env):
    ...
    def __init__(self, max_episode_steps=100, goal_sampler=None):
        ...
        self.is_semi = self.goal_sampler == semi_circle_goal_sampler or self.goal_sampler == semi_circle_edges_goal_sampler
    ...
    def visualise_behaviour(self,
        ...
        # plot goal
        if self.possible_tasks is not None:
            for possible_task in self.possible_tasks:
                axis.scatter(*possible_task, marker='x', color='b', s=50)
